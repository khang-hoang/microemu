        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (saveForWebChooser.showSaveDialog(Main.this) == JFileChooser.APPROVE_OPTION) {
                ...
                if (appletJarFile == null) {
                    ...
                    /*
                     * loc/org/microemu/microemulator/2.0.1-SNAPSHOT/microemulator-2.0.1-20070227.
                     * 080140-1.jar String version = doRegExpr(mainJarFileName, ); String basePath =
                     * "loc/org/microemu/" appletJarFile = new File(basePath +
                     * "microemu-javase-applet/" + version + "/microemu-javase-applet" + version +
        ...
        urlsMRU.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                if (event instanceof JMRUMenu.MRUActionEvent) {
                    Common.openMIDletUrlSafe(
                            ((MidletURLReference) ((JMRUMenu.MRUActionEvent) event).getSourceMRU()).getUrl());
                    if (recordStoreManagerDialog != null) {
                        recordStoreManagerDialog.refresh();
                    }
                }
        ...
        this.resizeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                if (SwingDialogWindow.show(Main.this, "Enter new size...", resizeDeviceDisplayDialog, true)) {
                    deviceDisplay
                            .setDisplayRectangle(new Rectangle(0, 0, resizeDeviceDisplayDialog.getDeviceDisplayWidth(),
